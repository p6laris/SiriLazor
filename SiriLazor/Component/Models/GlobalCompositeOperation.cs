namespace SiriLazor.Component.Models
{
    ...
    public static class GlobalCompositeOperation
    {
        ...
        public static readonly string DestinationAtop = "destination-atop";
        public static readonly string DestinationIn = "destination-in";
        public static readonly string DestinationOut = "destination-out";
        public static readonly string DestinationOver = "destination-over";
        ...
        public static readonly string SourceAtop = "source-atop";
        public static readonly string SourceIn = "source-in";
        public static readonly string SourceOut = "source-out";
        public static readonly string SourceOver = "source-over";
